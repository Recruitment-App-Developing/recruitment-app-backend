    ...
    public ResponseEntity<Response<CvProfileResponseDTO>> getCvProfile(
        ...
        return ResponseEntity.status(HttpStatus.OK)
                .body(Response.successfulResponse(
                        "Get CV profile successfull", cvProfileService.getCvProfile(cvProfileId)));
    }
    ...
    public ResponseEntity<Response<List<Education>>> updateEducaitonInCvProfile(
        ...
        return ResponseEntity.status(HttpStatus.OK)
                .body(Response.successfulResponse(
                        ...
                        cvProfileService.updateEducationInCvProfile(
                                requestDTO, AuthUtil.getRequestedUser().getId())));
    }
    ...
    public ResponseEntity<Response<List<Education>>> deleteEducationInCvProfile(
        ...
        return ResponseEntity.status(HttpStatus.OK)
                .body(Response.successfulResponse(
                        ...
                        cvProfileService.deleteEducationInCvProfile(
                                educationId, AuthUtil.getRequestedUser().getId())));
    }
}
