...
public class StatisticController {
    ...
    public ResponseEntity<Response<Map<String, Object>>> statisticGeneralJobByIndustry() {
        return ResponseEntity.status(HttpStatus.OK)
                .body(Response.successfulResponse("", statisticService.statisticGeneralJobByIndustry()));
    }
    ...
    public ResponseEntity<Response<Map<String, Object>>> statisticGeneralJobByDay() {
        return ResponseEntity.status(HttpStatus.OK)
                .body(Response.successfulResponse("", statisticService.statisticGeneralJobByDay()));
    }
    ...
    public ResponseEntity<Response<Map<String, Object>>> statisticCompanyJobByIndustry() {
        return ResponseEntity.status(HttpStatus.OK)
                .body(Response.successfulResponse(
                        "",
                        statisticService.statisticCompanyJobByIndustry(
    ...
    public ResponseEntity<Response<Map<String, Object>>> statisticApplicationStatusByCompany() {
        return ResponseEntity.status(HttpStatus.OK)
                .body(Response.successfulResponse(
                        "",
                        statisticService.statisticApplicationStatusByCompany(
                                AuthUtil.getRequestedUser().getId())));
    }
