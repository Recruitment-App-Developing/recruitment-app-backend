...
public class AuthenticationServiceImpl implements AuthenticationService {
    ...
    public Response<LoginResponseDTO> login(LoginRequestDTO requestDTO) {
        ...
        Boolean authenticated = passwordEncoder.matches(requestDTO.password(), accountResult.get().getPassword());
        ...
        return Response.successfulResponse(messageSourceUtil.getMessage(SuccessMessage.Auth.LOGIN_SUCCESS), responseDTO);
    }
